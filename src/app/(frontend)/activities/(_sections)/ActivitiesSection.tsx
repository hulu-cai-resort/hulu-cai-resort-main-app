...
function MobileActivityCard({ activity }: { activity: ActivityCard }) {
  return (
    <div className="flex w-full flex-col items-center gap-3">
      ...
      >
        ...
        <div className="flex w-full flex-col">
          <FeatureItem icon="location" text={`Letak: ${activity.location}`} />
          <FeatureItem icon="age" text={`Ketentuan Usia: ${activity.ageRequirement}`} />
          <FeatureItem icon="terms" text={activity.terms} />
        </div>
...
function TabletActivityCard({ activity }: { activity: ActivityCard }) {
  return (
...
function DesktopActivityCard({ activity }: { activity: ActivityCard }) {
  return (
...
function FeatureItem({ icon, text }: { icon: string; text: string }) {
  return (
    <div className="flex items-center gap-3 py-2 md:gap-4 md:py-[6px] lg:py-0">
