...
import type { EventsIndoorPage, EventsOutdoorPage } from '@/payload-types'
...
export function HeroSection({ eventsOutdoorPage }: HeroSectionProps) {
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-screen overflow-hidden">
        ...
        >
          {eventsOutdoorPage.heroImage &&
            typeof eventsOutdoorPage.heroImage === 'object' &&
            eventsOutdoorPage.heroImage.url && (
              <Image
                src={getMediaUrl(eventsOutdoorPage.heroImage.url)}
            ...
            <div className="max-w-[670px] space-y-4 lg:space-y-[13px]">
              ...
              <motion.div variants={itemVariants}>
                <p className="font-raleway text-wrap text-base font-semibold leading-[1.2] text-white/90 sm:text-xl lg:text-[20px] lg:leading-[1.2]">
                  {eventsOutdoorPage.heroDescription}
                </p>
              </motion.div>
            </div>
          </motion.div>
