...
export function HeroSection({ eventsPage }: HeroSectionProps) {
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-screen overflow-hidden">
        ...
        >
          {eventsPage.heroImage &&
            typeof eventsPage.heroImage === 'object' &&
            eventsPage.heroImage.url && (
              <Image
                src={getMediaUrl(eventsPage.heroImage.url)}
