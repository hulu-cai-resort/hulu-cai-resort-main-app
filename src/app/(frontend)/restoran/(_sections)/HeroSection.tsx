...
import type { DiningPage } from '@/payload-types'
...
export function HeroSection({ diningPage }: HeroSectionProps) {
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-screen overflow-hidden">
        ...
        >
          {diningPage.heroImage &&
            typeof diningPage.heroImage === 'object' &&
            diningPage.heroImage.url && (
              <Image
                src={getMediaUrl(diningPage.heroImage.url)}
