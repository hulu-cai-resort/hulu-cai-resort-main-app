...
import type { VillaPage } from '@/payload-types'
...
export function HeroSection({ villaPage }: HeroSectionProps) {
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-screen overflow-hidden">
        ...
        >
          {villaPage.heroBackgroundImage &&
            typeof villaPage.heroBackgroundImage === 'object' &&
            villaPage.heroBackgroundImage.url && (
              <Image
                src={getMediaUrl(villaPage.heroBackgroundImage.url)}
