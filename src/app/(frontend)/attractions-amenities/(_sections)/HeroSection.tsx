...
import type { AttractionAmenitiesPage } from '@/payload-types'
...
export function HeroSection({ attractionAmenitiesPage }: HeroSectionProps) {
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-screen overflow-hidden">
        ...
        >
          {attractionAmenitiesPage.heroImage &&
            typeof attractionAmenitiesPage.heroImage === 'object' &&
            attractionAmenitiesPage.heroImage.url && (
              <Image
                src={getMediaUrl(attractionAmenitiesPage.heroImage.url)}
        ...
        <Wrapper>
          ...
          >
            <div className="max-w-[670px] space-y-4 lg:space-y-[13px]">
              ...
              >
                {attractionAmenitiesPage.heroTitle}
              </motion.h1>
              ...
              <motion.div variants={itemVariants}>
                <p className="font-raleway text-wrap text-base font-semibold leading-[1.2] text-white/90 sm:text-xl lg:text-[20px] lg:leading-[1.2]">
                  {attractionAmenitiesPage.heroDescription}
                </p>
              </motion.div>
            </div>
          </motion.div>
