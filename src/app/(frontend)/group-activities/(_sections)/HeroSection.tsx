...
import type { ActivitiesPage } from '@/payload-types'
...
export function HeroSection({ activitiesPage }: HeroSectionProps) {
  return (
    <>
      {/* Hero Section */}
      <section className="relative h-screen overflow-hidden">
        ...
        >
          {activitiesPage.heroImage &&
            typeof activitiesPage.heroImage === 'object' &&
            activitiesPage.heroImage.url && (
              <Image
                src={getMediaUrl(activitiesPage.heroImage.url)}
            ...
            <div className="max-w-[670px] space-y-4 lg:space-y-[13px]">
              ...
              <motion.div variants={itemVariants}>
                <p className="font-raleway text-wrap text-base font-semibold leading-[1.2] text-white/90 sm:text-xl lg:text-[20px] lg:leading-[1.2]">
                  {activitiesPage.heroDescription}
                </p>
              </motion.div>
            </div>
          </motion.div>
