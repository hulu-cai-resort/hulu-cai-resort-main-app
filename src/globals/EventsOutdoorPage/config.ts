...
import { revalidateEventsOutdoorPage } from './hooks/revalidateEventsOutdoorPage'

export const EventsOutdoorPage: GlobalConfig = {
  slug: 'events-outdoor-page',
  label: 'Events Outdoor Page',
  access: {
    read: () => true,
  },
  hooks: {
    afterChange: [revalidateEventsOutdoorPage],
  },
  fields: [
    {
      type: 'tabs',
