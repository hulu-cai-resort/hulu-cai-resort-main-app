    ...
    <footer className="bg-[#092B1A] text-white">
      ...
      <div className="flex items-center justify-center px-8 py-16">
        <div className="relative flex w-full max-w-7xl items-center justify-center py-32">
          ...
          <div className="absolute inset-0 mx-auto max-w-7xl rounded-2xl bg-gradient-to-b from-[#1D1D1D]/60 via-transparent to-[#1D1D1D]"></div>
          ...
          <div className="relative z-10 max-w-2xl text-center">
            ...
            <button className="inline-flex items-center gap-3 rounded-xl bg-white/15 px-11 py-5 text-white backdrop-blur-md transition-all hover:bg-white/20">
        ...
        <div className="mx-auto max-w-7xl space-y-10">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-base font-medium">Alamat Jl.Alamat</span>
                </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-base font-medium">08555555551234</span>
                </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-base font-medium">hulucaicamp@gmail.com</span>
                </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-base font-medium">Hulucaicamp</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center justify-between gap-6 py-5 md:flex-row">
              <p className="text-sm">©2025 Hulu Cai Camp · All rights reserved.</p>
